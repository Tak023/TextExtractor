...
#ifndef TEXTEXTRACTOR_SWIFT_H
#define TEXTEXTRACTOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TextExtractor",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC13TextExtractor11AppDelegate")
...
SWIFT_CLASS("_TtC13TextExtractor20CaptureOverlayWindow")
...
SWIFT_CLASS("_TtC13TextExtractor19NotificationService")
...
@interface NotificationService (SWIFT_EXTENSION(TextExtractor)) <UNUserNotificationCenterDelegate>
...
@class NSCoder;
@class NSEvent;
SWIFT_CLASS("_TtC13TextExtractor20SelectionOverlayView")
@interface SelectionOverlayView : NSView
...
SWIFT_CLASS("_TtC13TextExtractor13SpeechService")
...
@interface SpeechService (SWIFT_EXTENSION(TextExtractor)) <AVSpeechSynthesizerDelegate>
